...
:star: Add Postman and JMeter converters

:star: Update README and k6-html-reporter

:star: Add Azure Pipelines

:star: Add k6-reporter as second option for reporting

:star: Add Github Actions and CircleCI

:star: InfluxDB with Grafana Dashboard for better report visualization
...
- Specify the path to json report and path to output directory in [html-report.js](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/src/utils/html-reporter.js)
...
- Run the test which already has handleSummary function specified, take a look at [animal-soak-test.js](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/tests/atwt/animal-soak-test.js)
...
- [Smoke testing](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/examples/smoke-test.js)
- [Load testing](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/examples/load-test.js)
- [Stress testing](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/examples/stress-test.js)
- [Soak testing](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/examples/soak-test.js)
...
- [run-threshold-test.sh](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/run-threshold-test.sh): To execute on Linux machines
- [run-threshold-test-wins.sh](https://github.com/VenkateshDoijode/k6-performance-test/blob/main/run-threshold-test-wins.sh): To run on Windows machines
...
<p align="center">
    ...
    <img src="https://user-images.githubusercontent.com/25218255/47360756-794c1f00-d6fa-11e8-86fa-7b1c2e4dda92.png" width="50">
		 ...
		 <a alt="LinkedIn" href="https://www.linkedin.com/in/venkateshwara-doijode/">
    <img src="https://user-images.githubusercontent.com/25218255/47360366-8583ac80-d6f9-11e8-8871-219802a9a162.png" width="50">
  </a>
		 <a alt="Facebook" href="https://www.facebook.com/VenkateshDoijode">
